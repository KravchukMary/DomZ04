...
$works = [
    [
        "name" => "Котёнок",
        "dataStart" => "Январь 2020",
        "dataEnd" => "Январь 2021",
        "description" => "Я был маленьким. Пил много молока и много спал.",
    ],
    [
        "name" => "Котейка подросток",
        "dataStart" => "Сентябрь 2021",
        "dataEnd" => "Август 2022",
        "description" => "Хорошо кушал, особенно колбаску и вырос в большого жирненького котика.
        Очень много хулиганил, даже свалил новогоднюю ёлку.",
    ],
    [
        "name" => "Царь семьи",
        "dataStart" => "Август 2022",
        "dataEnd" => "Текущее время",
        "description" => "Теперь я большой и важный. Отвоевал у цветка подоконник.
        Продолжение следует...",
    ],
];
?>
